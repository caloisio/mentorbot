...
class RelayControl(CommandBase):
    def __init__(self, controller: WPI_TalonSRX, controlPercent: typing.Callable[[], float]) -> None:
        CommandBase.__init__(self)
        self.horn = controller
        self.horn.set(ControlMode.PercentOutput, 0.0)
        self.controlPercent = controlPercent
        self.setOutputPercent = lambda percent: self.horn.set(ControlMode.PercentOutput, percent)
